...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk2_net [get_bd_pins S01_ACLK] [get_bd_pins aclk2] [get_bd_pins psr_aclk2/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk2_interconnect_aresetn [get_bd_pins S01_ARESETN] [get_bd_pins psr_aclk2/interconnect_aresetn]
