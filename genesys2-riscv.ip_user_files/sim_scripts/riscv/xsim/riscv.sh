...
xv_boost_lib_path=/mada/software/Xilinx/Vivado/2019.2/tps/boost_1_64_0
...
simulate()
{
  xsim riscv -key {Behavioral:sim_1:Functional:riscv} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fe52.protoinst" -protoinst "protoinst_files/riscv.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/mada/software/Xilinx/Vivado/2019.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
